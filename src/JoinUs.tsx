...
export const JoinUs: React.FC = () => {
  ...
  return (
    <div className="bg-herb-bg pb-20">
      <Helmet>
        <title>Join Multistream Worldwide | Business Opportunity & Ranks</title>
        <meta name="description" content="Discover financial freedom with Multistream Worldwide. Become a member, explore rank rewards like Sapphire, Gold, and Diamond, and build your legacy with Jinja Herbal." />
        <link rel="canonical" href="https://jinjaproducts.com.ng/join-us" />
        <meta property="og:title" content="Join the Multistream Network" />
        <meta property="og:description" content="Unlock rewards and achieve financial independence. Join our global network of entrepreneurs." />
      </Helmet>
      {/* Hero Section */}
      <section className="bg-herb-primary py-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-6 py-2 rounded-full border border-white/20 mb-8">
              ...
              <span className="text-white font-bold uppercase tracking-widest text-sm">Become a Member</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-display font-bold text-white mb-6">Join Multistream Worldwide</h1>
            <p className="text-herb-secondary max-w-2xl mx-auto text-lg leading-relaxed">
              Start your journey to financial freedom and holistic wellness today. Explore our registration packages and rank rewards.
            </p>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact')}
              className="mt-10 bg-herb-accent text-gray-900 px-10 py-4 rounded-2xl font-bold text-lg hover:brightness-110 shadow-xl transition-all"
            >
      ...
      <section className="py-20 -mt-10 relative z-20">
        <div className="max-w-5xl mx-auto px-4">
          <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-2xl border border-gray-100 text-center relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-bold text-gray-900 mb-6">
            ...
            <div className="w-40 h-1.5 bg-herb-accent mx-auto rounded-full"></div>
          </div>
        </div>
      </section>
